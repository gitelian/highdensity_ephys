...
file_path = uigetdir('/media/greg/Data/Neuro/', 'Select folder to extract neural data');
...
for electrode = 1:num_electrodes
    ...
    fid2write = fopen([new_folder_path filesep fname '-e' num2str(electrode) '.phy.dat'], 'w');
